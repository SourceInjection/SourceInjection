...
namespace SourceInjection.Test.Equals.Comparisons
{
    [TestFixture]
    public class ComparisonsTests
    {
        ...
        public void PropertyEqualization_WithCollection_ThatIsNotComparableBySequenceEqual_UsesSourceInjectionSequenceEqual(string propertyName)
        {
            var sut = EqualsMethod.FromType<ClassWithCollections_ThatAreNotEquatableBySequenceEqual>();
            Assert.That(sut.Body.Contains(Equalization.SourceInjectionCollection(propertyName, false)));
        }
        ...
        public void PropertyEqualization_WithMultiDimensionalArray_UsesSourceInjectionArraySequenceEqual(string propertyName)
        {
            var sut = EqualsMethod.FromType<ClassWithMultiDimensionalArrays>();
            Assert.That(sut.Body.Contains(Equalization.SourceInjectionArray(propertyName, false)));
        }
